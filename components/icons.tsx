...
export const Medal = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 20.94c-3.14-.5-5.23-1.6-6.42-3.18a3.7 3.7 0 0 1 .28-4.42l.03-.03L12 7l6.11 6.31.03.03a3.7 3.7 0 0 1 .28 4.42C17.23 19.34 15.14 20.44 12 20.94z"/><path d="m12 7-1.95 2.82c-.12.17-.18.37-.18.58v4.2c0 .21.06.41.18.58L12 18l2.13-2.82c.12-.17.18-.37.18-.58v-4.2c0-.21-.06-.41-.18-.58L12 7z"/><path d="M12 22s-4-2-4-4 4-4 4-4 4 2 4 4-4 4-4 4zM8.5 10.5l-3 3M18.5 13.5l-3-3"/></svg>
);
...
export const Trophy = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M9 22h6"/><path d="M12 13V2"/><path d="M6 13c0 3.866 2.686 7 6 7s6-3.134 6-7"/><path d="M6 9a6 6 0 0 1 12 0"/></svg>
);

export const Brain = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.98-1.57 2.5 2.5 0 0 1-2.4-2.86A2.5 2.5 0 0 1 4.5 12V4.5A2.5 2.5 0 0 1 7 2h2.5z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.98-1.57 2.5 2.5 0 0 0 2.4-2.86A2.5 2.5 0 0 0 19.5 12V4.5A2.5 2.5 0 0 0 17 2h-2.5z"/></svg>
);
...
export const Sparkles = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m18 8-2-2-2 2 2 2 2-2Zm-4 4-2-2-2 2 2 2 2-2Zm2-8-2-2-2 2 2 2 2-2Zm-4 4-2-2-2 2 2 2 2-2Z"/></svg>
);

export const Lightbulb = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 14c.2-1 .7-1.7 1.5-2.5C17.7 10.2 18 9 18 8c0-2.2-1.8-4-4-4-3.1 0-4.5 2.5-4.5 5 0 1.2.3 2.2 1.5 3.5.7.7 1.2 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
);
...
export const Coins = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="8" cy="8" r="6"/><path d="M18.09 10.71a6 6 0 1 1-2.39-2.4"/><path d="M8 14v1.5a2.5 2.5 0 0 0 5 0V14"/><path d="M8 6V4.5a2.5 2.5 0 0 1 5 0V6"/></svg>
);
...
export const BarChart3 = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18"/><path d="M7 12v4"/><path d="M12 8v8"/><path d="M17 4v12"/></svg>
);

export const Footprints = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 16.2A2 2 0 0 1 6 15h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-1.8Z"/><path d="M12.5 21.2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1.5Z"/><path d="m9 12.8.7-2.3a2 2 0 0 1 2.6-1.5l2.7 1.5"/><path d="m15 5.8-.7 2.3a2 2 0 0 0 2.6 1.5l2.7-1.5"/></svg>
);
...
export const AILoader = (props: IconProps) => (
  <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {...props}>
    ...
    `}</style>
    <rect className="bar" x="4" y="4" width="4" height="16" rx="1"/>
    <rect className="bar" x="10" y="4" width="4" height="16" rx="1"/>
    <rect className="bar" x="16" y="4" width="4" height="16" rx="1"/>
  </svg>
);
...
export const FlaskConical = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 2v10.34l-5.88 5.88a2 2 0 0 0 2.83 2.83L13 15.17V2h-3z"/><path d="M8.5 2h7"/><path d="M7 16h10"/></svg>
);
...
export const GoogleDrive = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M19.33 7.12H8.38l-3.33 5.76h10.95l3.33-5.76zM8.2 17.65l3.33-5.77 3.33 5.77H8.2zM7.12 6.06l-3.33 5.77 3.33 5.76 3.33-5.76-3.33-5.77z"/>
  </svg>
);
...
export const Play = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><polygon points="5 3 19 12 5 21 5 3"/></svg>
);
...
export const Spectrum = (props: IconProps) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2ZM12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4Z" fill="url(#spectrum-gradient)"/>
  </svg>
);
