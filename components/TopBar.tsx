...
const TopBar: React.FC<TopBarProps> = ({ user }) => {
  return (
    <header className="h-16 border-b border-white/5 bg-brand-dark/50 backdrop-blur-md sticky top-0 z-40 px-8 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <p className="text-[10px] text-gray-500 mt-1 uppercase tracking-tighter">{user.role}</p>
          </div>
